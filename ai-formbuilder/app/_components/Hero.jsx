  ...
  <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen ">
    <div className="mx-auto max-w-xl text-center">
      <h1 className="text-3xl font-extrabold sm:text-5xl ">
        Create Forms not in Minutes.
        <strong className="font-extrabold text-primary sm:block"> But In Seconds. </strong>
      </h1>

      <p className="font-bold mt-4 sm:text-xl/relaxed">
      Build Smarter, Not Harder – Effortless Forms with AI Power!!
      </p>
